...
4. Пулинговый или сверточный слой
6. Слой преобразования матрицы в одномерный вектор
7. Полносвязные слои с функцией активации для взвешенной комбинации признаков
